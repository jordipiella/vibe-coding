import { healthResponseSchema, type HealthResponse, pingResponseSchema, type PingResponse, readinessResponseSchema, type ReadinessResponse, versionResponseSchema, type VersionResponse } from '@vibe/contracts';
